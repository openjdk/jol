...
Its original version was developed by John Hamer in 2004 and released under GNU GPL (see the https://www.cs.auckland.ac.nz/~j-hamer/LJV.html[original project page]).

This project aims to upgrade this tool to modern Java and make it an open source library in the modern sense of the word.

=== Getting started

You can use Maven or Gradle to import the https://search.maven.org/artifact/org.atp-fivt/ljv[LJV dependency]:
