...
public class CurrentLayouter implements Layouter {
    ...
    public ClassLayout layout(ClassData data) {
        ...
        if (data.isArray()) {
            ...
            return ClassLayout.createClassLayout(data, result, vm.arrayHeaderSize(), instanceSize, false);
        }
        ...
        return ClassLayout.createClassLayout(data, result, vm.objectHeaderSize(), instanceSize, true);
    }
